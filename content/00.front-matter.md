...
+ **{{author.name}}**<br>
  ...
  {%- endif %}
  {%- if author.mastodon is defined and author.mastodon is not none and author.mastodonserver is defined and author.mastodonserver is not none %}
  · ![Mastodon icon](images/mastodon.svg){.inline_icon}
  [\@{{author.mastodon}}@{{author.mastodonserver}}](https://{{author.mastodonserver}}/@{{author.mastodon}})
  {%- endif %}<br>
  <small>
