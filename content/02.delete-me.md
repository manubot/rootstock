...
Table: A table with merged cells
{#tbl: merged-cells}
...
Adding arbitrary HTML attributes with the `attributes` plugin:
...
Manubot Manubot.
Manubot.
<!-- $id="paragraph_of_text" $style="color: #ad1457; margin-left: 40px;" $disabled="true" $title="a paragraph of text" $data-color="red" -->
